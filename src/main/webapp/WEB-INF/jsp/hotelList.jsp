    ...
    <div class="layui-container">
        ...
        <ul class="layui-nav" id="layui-nav-userinfo">
            ...
            <li data-id="room" class="layui-nav-item layui-hide-xs layui-this">
                <a class="fly-case-active" data-type="toTopNav" href="/room/roomList">房间</a>
            </li>
            ...
            <div class="layui-card-body">
                <div class="store-cat-item"> <span><i class="layui-icon layui-icon-shop-fenlei"></i>类别：</span>
                    <ul id="getAllRoomType">
                        ...
                        <li data-id="0" <c:if test="${typeId == null}">class="active"</c:if>> <a class="fly-case-active" href="/room/roomList.html" data-type="toRoomTypeListByLists">全部</a></li>
                        <c:forEach var="roomType" items="${roomTypeList}">
                            <%-- 判断typeId房型ID值是否与房型列表中ID值相等，相等则选择该超链接，设置字体颜色为绿色 --%>
                            <li data-id="${roomType.id}" <c:if test="${typeId ==  roomType.id}">class="active"</c:if>> <a class="fly-case-active" href="/room/roomList/${roomType.id}.html" data-type="toRoomTypeListByLists">${roomType.typename}</a> </li>
                        </c:forEach>
                    </ul>
                </div>
                    ...
                    <a class="template store-list-box fly-case-active" href="/room/${room.id}.html" data-type="toRoomInfo">
                        ...
                        <div> <label class="layui-badge-rim store-list-pay"> ￥${room.price} </label>
                            <div class="store-list-colorbar">
                                ...
                                <span class="store-color-bar" style="border-color: #01aaed;color: #01aaed;border-width: 1px;border-style: solid;background-color: #fff;    text-align: center;">${room.name}</span>
                            </div>
                        </div>
                    </a>
                </div>
